...
class Category(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE)  # on_delete=models.CASCADE  --
...
class Transaction(models.Model):
    ...
    # равным NULL
    description = models.TextField(blank=True)  # blank=True -- поле обязательное для заполнения
